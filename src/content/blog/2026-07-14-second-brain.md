...
tags: ["knowledge management", "AI agents", "second brain", "provenance", "tooling"]
...
heroImage: "../../assets/blog/second-brain-hero.png"
---
...
![An abstract illustration of a single stream of light entering from the left and blossoming into an interconnected web of glowing nodes on the right.](/blog/second-brain-pipeline.png)
...
![An abstract illustration of a single glowing document sealed with a luminous fingerprint of light, threads radiating out to connect it to distant nodes.](/blog/second-brain-receipt.png)
